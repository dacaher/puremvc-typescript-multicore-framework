...
define("interfaces/INotification", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("interfaces/INotifier", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("interfaces/ICommand", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("interfaces/IController", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("interfaces/IMediator", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("interfaces/IObserver", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("interfaces/IView", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("patterns/observer/Observer", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("core/View", ["require", "exports", "patterns/observer/Observer"], function (require, exports, Observer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    ...
    var View = /** @class */ (function () {
        ...
        View.prototype.registerMediator = function (mediator) {
            ...
            if (len > 0) {
                ...
                var observer = new Observer_1.Observer(mediator.handleNotification, mediator);
...
define("core/Controller", ["require", "exports", "patterns/observer/Observer", "core/View"], function (require, exports, Observer_2, View_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    ...
    var Controller = /** @class */ (function () {
        ...
        Controller.prototype.registerCommand = function (notificationName, commandClassRef) {
            if (!this.commandMap[notificationName]) {
                this.view.registerObserver(notificationName, new Observer_2.Observer(this.executeCommand, this)); // ! -> non-null assertion operator
            }
        ...
        Controller.prototype.initializeController = function () {
            this.view = View_1.View.getInstance(this.multitonKey);
        };
        /**
...
define("interfaces/IProxy", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
...
define("core/Model", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("interfaces/IFacade", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("patterns/observer/Notification", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("patterns/facade/Facade", ["require", "exports", "core/Controller", "core/Model", "core/View", "patterns/observer/Notification"], function (require, exports, Controller_1, Model_1, View_2, Notification_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    ...
    var Facade = /** @class */ (function () {
        ...
        Facade.prototype.sendNotification = function (name, body, type) {
            if (body === void 0) { body = null; }
            this.notifyObservers(new Notification_1.Notification(name, body, type));
        };
        /**
        ...
        Facade.prototype.initializeModel = function () {
            if (!this.model) {
                this.model = Model_1.Model.getInstance(this.multitonKey);
            }
        };
        /**
        ...
        Facade.prototype.initializeController = function () {
            if (!this.controller) {
                this.controller = Controller_1.Controller.getInstance(this.multitonKey);
            }
        };
        /**
        ...
        Facade.prototype.initializeView = function () {
            if (!this.view) {
                this.view = View_2.View.getInstance(this.multitonKey);
            }
        };
        /**
         * @constant
...
define("patterns/observer/Notifier", ["require", "exports", "patterns/facade/Facade"], function (require, exports, Facade_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    ...
    var Notifier = /** @class */ (function () {
        ...
        Notifier.prototype.facade = function () {
            ...
            return Facade_1.Facade.getInstance(this.multitonKey);
        };
        /**
         * Message Constants
         *
...
define("patterns/command/MacroCommand", ["require", "exports", "patterns/observer/Notifier"], function (require, exports, Notifier_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("patterns/command/SimpleCommand", ["require", "exports", "patterns/observer/Notifier"], function (require, exports, Notifier_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("patterns/mediator/Mediator", ["require", "exports", "patterns/observer/Notifier"], function (require, exports, Notifier_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("patterns/proxy/Proxy", ["require", "exports", "patterns/observer/Notifier"], function (require, exports, Notifier_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("puremvc", ["require", "exports", "core/Controller", "core/Model", "core/View", "patterns/command/MacroCommand", "patterns/command/SimpleCommand", "patterns/facade/Facade", "patterns/mediator/Mediator", "patterns/observer/Notification", "patterns/observer/Notifier", "patterns/observer/Observer", "patterns/proxy/Proxy"], function (require, exports, Controller_2, Model_2, View_3, MacroCommand_1, SimpleCommand_1, Facade_2, Mediator_1, Notification_2, Notifier_5, Observer_3, Proxy_1) {
    "use strict";
    function __export(m) {
        for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
    }
    Object.defineProperty(exports, "__esModule", { value: true });
    __export(Controller_2);
    __export(Model_2);
    __export(View_3);
    __export(MacroCommand_1);
    __export(SimpleCommand_1);
    __export(Facade_2);
    __export(Mediator_1);
    __export(Notification_2);
    __export(Notifier_5);
    __export(Observer_3);
    __export(Proxy_1);
});
