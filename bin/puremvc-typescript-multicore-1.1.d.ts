declare module "interfaces/INotification" {
    /**
...
declare module "interfaces/INotifier" {
    /**
...
declare module "interfaces/ICommand" {
...
declare module "interfaces/IController" {
    import { INotification } from "interfaces/INotification";
    /**
...
declare module "interfaces/IMediator" {
    import { INotification } from "interfaces/INotification";
    import { INotifier } from "interfaces/INotifier";
    /**
    ...
    export interface IMediator extends INotifier {
         ...
         *
         * <code>
         * getMenu: function { return this.viewComponent; }
         * </code>
         *
         * @return
...
declare module "interfaces/IObserver" {
    import { INotification } from "interfaces/INotification";
    /**
...
declare module "interfaces/IView" {
...
declare module "patterns/observer/Observer" {
    import { INotification } from "interfaces/INotification";
    import { IObserver } from "interfaces/IObserver";
    /**
...
declare module "core/View" {
    ...
    export class View implements IView {
         ...
         * @protected
         */
        protected static readonly MULTITON_MSG: string;
        /**
...
declare module "interfaces/IProxy" {
    import { INotifier } from "interfaces/INotifier";
    /**
...
declare module "interfaces/IFacade" {
    import { IMediator } from "interfaces/IMediator";
    import { INotification } from "interfaces/INotification";
    import { INotifier } from "interfaces/INotifier";
    import { IProxy } from "interfaces/IProxy";
...
declare module "patterns/observer/Notification" {
    import { INotification } from "interfaces/INotification";
    /**
...
declare module "patterns/facade/Facade" {
    import { IController } from "interfaces/IController";
...
declare module "patterns/observer/Notifier" {
    import { IFacade } from "interfaces/IFacade";
    import { INotifier } from "interfaces/INotifier";
    /**
...
declare module "patterns/command/MacroCommand" {
...
declare module "patterns/command/SimpleCommand" {
    import { ICommand } from "interfaces/ICommand";
    import { INotification } from "interfaces/INotification";
    import { INotifier } from "interfaces/INotifier";
    import { Notifier } from "patterns/observer/Notifier";
...
declare module "patterns/mediator/Mediator" {
    import { IMediator } from "interfaces/IMediator";
    import { INotification } from "interfaces/INotification";
    import { INotifier } from "interfaces/INotifier";
    import { Notifier } from "patterns/observer/Notifier";
...
declare module "patterns/proxy/Proxy" {
    import { INotifier } from "interfaces/INotifier";
    import { IProxy } from "interfaces/IProxy";
    import { Notifier } from "patterns/observer/Notifier";
    /**
